...
<body>
    ...
    <div class="row">
        <div class="column">
            <p><a href="books?value=BusinessEconomics" type="text" name="Comics Graphic" method="POST">
        ...
        <div class="column">
            <center>
                <p><a href="books?value=ChildrensBooks" type="text" name="Arts And Music"
                        method="POST">
        ...
        <div class="column">
            <p><a href="books?value=ComicsGraphic" type="text" name="Comics&Graphic" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Novels" type="text" name="Business" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=FamilyRelationships" type="text" name="Travel" method="POST">
    ...
    <div class="row">
        <div class="column">
            <p><a href="books?value=Languages" type="text" name="Cooking" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Religion" type="text" name="Edu And Reference"
                    method="POST">
        ...
        <div class="column">
            <p><a href="books?value=ComputersInternet" type="text" name="Entertaiment" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=DesigntheArts" type="text" name="Health And Fitness"
                    method="POST">
        ...
        <div class="column">
            <p><a href="books?value=HistoryPolitics" type="text" name="History" method="POST">
    ...
    <div class="row">
        <div class="column">
            <p><a href="books?value=HealthWellBeing" type="text" name="Home And Garden"
                    method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Sport" type="text" name="Horror" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=HobbiesCollectibles" type="text" name="Kids" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=SocialScience" type="text" name="Literature And Fiction" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Science" type="text" name="Medical" method="POST">
    ...
    <div class="row">
        <div class="column">
            <p><a href="books?value=FoodDrink" type="text" name="Parenting" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=SelfEnrichment" type="text" name="Religion" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Localstudy" type="text" name="Romance" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Textbooks" type="text" name="Sci-fi And Fantasy"
                    method="POST">
        ...
        <div class="column">
            <p><a href="books?value=LanguageExam" type="text" name="Science And Math"
                    method="POST">
    ...
    <div class="row">
        <div class="column">
            <p><a href="books?value=InternationalExam" type="text" name="Sport" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Fiction" type="text" name="Computer And Tech"
                    method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Nonfiction" type="text" name="Hobbies And Crafts"
                    method="POST">
        ...
        <div class="column">
            <p><a href="books?value=ChineseBooks" type="text" name="Mysteries" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=JapaneseBooks" type="text" name="Self-help" method="POST">
    ...
    <div class="row">
        <div class="column">
            <p><a href="books?value=Lifestyle" type="text" name="Parenting" method="POST">
        ...
        <div class="column">
            <p><a href="books?value=Others" type="text" name="Religion" method="POST">
